...
function getStableViewCount(projectId: string) {
  let hash = 0;
  ...
  if (!isLoggedIn) {
    return (
      <Link
        ...
        className="group flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-[#E5E7EB] bg-white hover:border-[#D1D5DB] transition-all duration-300"
        title="Sign in to like"
      >
        <Heart className="w-[18px] h-[18px] text-[#9CA3AF] group-hover:text-red-400 transition-colors" />
        <span className="text-[14px] font-semibold text-[#4B5563]">{likes}</span>
      </Link>
    );
  }
  ...
  return (
    <form action={toggleLike}>
      ...
      <button
        ...
        style={{
          borderColor: optimisticLiked ? "rgba(239,68,68,0.2)" : "#E5E7EB",
      ...
      >
            ...
            <>
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <motion.span
                  ...
                  style={{
                    background: i % 2 === 0 ? "#ef4444" : "#20F5A0",
                  }}
                />
              ))}
            </>
        ...
        <span
          ...
          style={{ color: optimisticLiked ? "#ef4444" : "#4B5563" }}
        >
          {optimisticCount}
        </span>
      </button>
  ...
  return (
    <div className="flex items-center gap-2">
      <motion.button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#E5E7EB] bg-white text-[13px] font-medium text-[#4B5563] hover:border-[#D1D5DB] hover:text-[#111111] transition-all duration-200"
      >
        <AnimatePresence mode="wait">
          {copied ? (
            <motion.span
              ...
              exit={{ scale: 0 }}
            >
              <Check className="w-3.5 h-3.5 text-[#20F5A0]" />
            </motion.span>
          ) : (
            <motion.span
              key="link"
...
function TechPill({ tech, index }: { tech: string; index: number }) {
  ...
  return (
    <motion.span
      ...
      style={{
        background: hovered ? "#111111" : "#F3F4F6",
        color: hovered ? "#20F5A0" : "#4B5563",
        boxShadow: hovered
...
function StatPill({
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg bg-white border border-[#E5E7EB] shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
    >
      <span className="text-[#9CA3AF]">{icon}</span>
      <div>
        <p className="text-[12px] text-[#9CA3AF] leading-none mb-0.5">{label}</p>
...
export default function ProjectDetailClient({
  ...
  const viewCount = project ? getStableViewCount(project.id) : 0;
  ...
  return (
    <div className="max-w-[860px] mx-auto px-6 sm:px-8 py-10 md:py-16">
      ...
      >
        <Link
          href="/builders"
          className="inline-flex items-center gap-2 text-[13px] text-[#9CA3AF] hover:text-[#111111] transition-colors mb-8 font-medium group"
        >
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(32,245,160,0.08) 0%, transparent 100%)",
            }}
          />
        ...
        <div className="bg-white border border-[#E5E7EB] border-t-0 rounded-b-[20px] px-6 sm:px-8 pb-6 pt-6">
          {/* Category badge */}
          <motion.div
            ...
            className="mb-4"
          >
            <span className="inline-flex items-center px-3.5 py-1.5 rounded-full bg-[#111111] text-[#20F5A0] text-[11px] font-bold uppercase tracking-[0.08em]">
          ...
          <motion.p
            ...
            className="text-[17px] text-[#4B5563] leading-relaxed mb-6 max-w-[600px]"
          >
            {project.tagline}
          </motion.p>
      ...
      >
        {project.demoUrl && (
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[14px] font-semibold transition-all duration-300 hover:shadow-[0_4px_16px_rgba(32,245,160,0.3)] hover:-translate-y-[1px]"
        ...
        {project.sourceUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-[#E5E7EB] bg-white text-[14px] font-semibold text-[#111111] hover:border-[#D1D5DB] hover:shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-[1px]"
          >
      ...
      <motion.div
        ...
        className="rounded-lg bg-white border border-[#E5E7EB] p-6 sm:p-8 mb-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
      >
        <h2 className="text-[11px] font-bold uppercase tracking-[0.1em] text-[#9CA3AF] mb-4">
          About this project
        </h2>
        <p className="text-[15px] text-[#4B5563] leading-[1.85] whitespace-pre-line">
          {project.description}
        </p>
      </motion.div>
      ...
      {project.techStack.length > 0 && (
        <motion.div
          ...
          className="rounded-lg bg-white border border-[#E5E7EB] p-6 sm:p-8 mb-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
        >
          <h2 className="text-[11px] font-bold uppercase tracking-[0.1em] text-[#9CA3AF] mb-5">
            Tech stack
          </h2>
      ...
      >
        ...
        <Link
          ...
          className="group flex items-center gap-4 p-4 -m-4 rounded-lg hover:bg-[#FAFAFA] transition-colors duration-200"
        >
          <div
            className="w-14 h-14 rounded-lg flex items-center justify-center shrink-0 shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <ArrowUpRight className="w-4 h-4 text-[#9CA3AF] opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-200" />
            </div>
            <p className="text-[13px] text-[#6B7280]">
              @{project.builder.username}
            </p>
          </div>
          <div className="shrink-0 px-3.5 py-1.5 rounded-full bg-[#F3F4F6] text-[12px] font-medium text-[#4B5563] group-hover:bg-[#111111] group-hover:text-[#20F5A0] transition-all duration-300">
            View profile
          </div>
        </Link>
      </motion.div>
      ...
      <motion.div
        ...
        className="flex flex-wrap items-center gap-3 mb-10 text-[12px] text-[#9CA3AF] font-medium"
      >
        <span className="px-3 py-1.5 rounded-full bg-[#F3F4F6]">
          {categoryLabels[project.category] || project.category}
        </span>
        <span className="px-3 py-1.5 rounded-full bg-[#F3F4F6]">
      ...
      {similarProjects.length > 0 && (
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href={`/builders/${project.builder.username}`}
              className="text-[13px] font-medium text-[#9CA3AF] hover:text-[#111111] transition-colors flex items-center gap-1"
            >
