...
/**
 * Error boundary for the /hackathons route segment. Catches errors thrown
 * while rendering the hackathon list or a hackathon page and offers a
 * recovery path.
 */
  ...
  return (
    <main className="flex min-h-[100svh] items-center justify-center bg-[#F7F8FA] px-6 py-16">
      <div className="w-full max-w-[520px]">
        <ErrorState
          title="Hackathons failed to load"
          reset={reset}
          showRetry
          description={
            error.message ||
            "We hit a snag loading hackathons. Try again in a moment."
          }
          action={
