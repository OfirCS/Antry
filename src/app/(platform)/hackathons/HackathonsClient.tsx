...
export default function HackathonsClient({
  ...
  const featuredCountdown = useCountdown(featuredTarget);
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA]">
        ...
        {featuredHackathon && (
          <Link href={`/hackathons/${featuredHackathon.id}`} className="group block mt-6">
            <motion.div
              ...
              className="relative overflow-hidden rounded-lg bg-[#111] p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center gap-5 transition-shadow duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)]"
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 shrink-0 relative z-10 flex-wrap">
                ...
                {featuredTarget && (
                  <span className="text-[12px] sm:text-[13px] font-bold tabular-nums text-white/80 bg-white/10 px-3 py-1.5 rounded-md border border-white/10">
                    {formatCountdown(featuredCountdown)}
                  </span>
                )}

                <span className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-md bg-white text-[#111] text-[13px] font-bold transition-transform duration-200 group-hover:scale-105 min-h-[44px]">
                  Join
      ...
      <div className="sticky top-[56px] z-40 backdrop-blur-xl border-b border-[#111]/[0.06] bg-[#F7F8FA]/90">
      ...
      <div className="max-w-[960px] mx-auto px-4 sm:px-6 pb-16">
        <div className="rounded-lg bg-[#111] p-6 sm:p-10 text-center">
          ...
          <Link
            href="/submit"
            className="inline-flex items-center gap-2 mt-5 px-6 py-3.5 sm:py-3 rounded-md bg-white text-[#111] text-[14px] font-semibold transition-transform hover:scale-[1.02] active:scale-[0.98] min-h-[48px]"
          >
            Get started
  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 px-4 sm:px-5 py-4 rounded-md bg-white border border-[#111]/[0.06] transition-all duration-200 hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:-translate-y-[1px] min-h-[64px]"
      >
