...
function CountdownDigit({
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className={`relative ${size} rounded-2xl flex items-center justify-center ${fontSize} font-bold tabular-nums`}
        style={{
          background: "#FFFFFF",
          color: "#111111",
    ...
    <div className="min-h-screen" style={{ background: "#FAFAFA" }}>
            ...
            <div className="max-w-[960px] mx-auto px-8 py-6">
              ...
              >
                ...
                <select
                  name="project_id"
                  required
                  className="flex-1 max-w-sm px-4 py-2.5 border rounded-xl text-[13px] outline-none transition-colors"
                  style={{
                    background: "#FFFFFF",
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl font-semibold text-[13px] transition-opacity disabled:opacity-50"
      ...
      >
        <div className="max-w-[960px] mx-auto flex items-center justify-between flex-wrap gap-6">
          ...
          <Link
            href="#"
            className="px-6 py-2.5 border rounded-xl text-[13px] font-semibold transition-colors"
            style={{
  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 px-8">
      ...
      <div
        ...
        style={{
          background: isLive
            ? "radial-gradient(ellipse 100% 70% at 30% 0%, rgba(198, 241, 53, 0.12) 0%, transparent 60%)"
            : "radial-gradient(ellipse 100% 70% at 70% 0%, rgba(198, 241, 53, 0.08) 0%, transparent 60%)",
        }}
      />
      {/* Dot pattern */}
      <div
          ...
          <span
            ...
            style={{
              background: isLive
                ...
                : "rgba(17,17,17,0.04)",
              color: "#111111",
              border: `1px solid ${isLive ? "rgba(198, 241, 53, 0.25)" : "rgba(17,17,17,0.08)"}`,
            }}
          >
            {isLive ? (
              <>
                <span
                  ...
                  style={{
                    background: "#C6F135",
                    boxShadow: "0 0 12px rgba(198, 241, 53, 0.6)",
                  }}
                />
                Live Now
              </>
        ...
        >
          {!isLoggedIn ? (
            <Link
              ...
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl text-[15px] font-bold transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
              style={{
                background: "#111111",
                color: "#FFFFFF",
            ...
            <div className="flex items-center gap-3">
              <span
                className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl text-[14px] font-bold"
                style={{
      ...
      <div className="max-w-[960px] mx-auto px-8 py-6 flex items-center justify-between flex-wrap gap-6">
        ...
        <div className="flex items-center gap-3">
          {!isLoggedIn ? (
            <Link
              href={`/login?redirect=/hackathons/${event.id}`}
              className="px-6 py-2.5 rounded-xl font-semibold text-[13px] transition-all duration-300 hover:scale-[1.02]"
              style={{ background: "#C6F135", color: "#111111" }}
            >
              Sign in to join
            </Link>
            ...
            <>
              {event.status === "active" &&
                availableProjects.length > 0 && (
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl font-semibold text-[13px] transition-all duration-300 inline-flex items-center gap-2 hover:scale-[1.02]"
                    style={{
                      background: "#C6F135",
                      color: "#111111",
                    }}
              ...
              <form action={leaveHackathon}>
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 border rounded-xl font-semibold text-[13px] transition-colors inline-flex items-center gap-2 hover:border-red-400 hover:text-red-500"
                  style={{
                    borderColor: "rgba(17, 17, 17, 0.1)",
                    color: "rgba(17, 17, 17, 0.5)",
                  }}
            ...
            <form action={joinHackathon}>
              ...
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl font-semibold text-[13px] transition-all duration-300 active:scale-[0.97] hover:scale-[1.02]"
                style={{
                  background: "#C6F135",
                  color: "#111111",
                }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {submissions.map((p, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="group relative rounded-2xl overflow-hidden border cursor-pointer transition-all duration-300 hover:shadow-lg"
                style={{
                  background: "#FFFFFF",
                  borderColor: "rgba(17, 17, 17, 0.06)",
        ...
        <div className="flex items-center justify-center gap-10 flex-wrap">
          {sponsors.map((sponsor, i) => (
            <motion.div
              ...
              className="flex items-center gap-3 px-6 py-4 rounded-2xl transition-all duration-300 hover:shadow-md"
              style={{
                background: "rgba(17, 17, 17, 0.02)",
