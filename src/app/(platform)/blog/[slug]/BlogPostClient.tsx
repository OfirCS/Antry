...
export default function BlogPostClient({ post }: { post: BlogPostData }) {
  ...
  return (
    <div ref={articleRef} style={{ background: "#FAFAF7" }} className="min-h-screen">
        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 min-w-0 max-w-[720px]">
            ...
            >
              ...
              {/* Author + Date row */}
              <div className="flex items-center gap-4 pt-6 border-t" style={{ borderColor: "#EBEBEB" }}>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  style={{
                    borderRadius: "12px",
                    background: copied ? "#C6F135" : "#F5F5F5",
                    color: copied ? "#111111" : "#737373",
                  }}
                  title="Copy link"
                >
                  {copied ? (
