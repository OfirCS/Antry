          ...
          {categories.map((cat) => (
            <button
              ...
              style={{
                ...
                color: activeCategory === cat ? "#C6F135" : "#737373",
                border:
                  activeCategory === cat
                    ? "1px solid #111111"
                    : "1px solid #EBEBEB",
  ...
  return (
    ...
    >
      <div className="p-8 sm:p-10">
        ...
        {/* Title */}
        <h2
          className="font-display text-[clamp(1.5rem,3vw,2rem)] tracking-[-0.02em] leading-[1.15] mb-4 transition-colors duration-300 group-hover:text-[#C6F135]"
          style={{ color: "#ffffff" }}
        >
          {post.title}
        </h2>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {post.authorAvatar ? (
                ...
                <User className="w-4 h-4" style={{ color: "#C6F135" }} />
              )}
            </div>
            <span
  ...
  return (
    ...
    >
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="flex items-center justify-between pt-4 border-t" style={{ borderColor: "#F5F5F5" }}>
          <div className="flex items-center gap-2">
            ...
            >
              {post.authorAvatar ? (
                ...
                <User className="w-3 h-3" style={{ color: "#A3A3A3" }} />
              )}
            </div>
            <span
