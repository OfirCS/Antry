...
function MockBuilderProfile() {
  return (
    <div
      className="rounded-lg p-6 w-full max-w-[380px]"
      style={{
        background: "#FFFFFF",
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        <div
          className="w-11 h-11 rounded-md flex items-center justify-center text-[13px] font-bold text-white"
        ...
        <div>
          ...
          <div className="text-[12px]" style={{ color: "#6B7280" }}>Full-stack AI builder</div>
        </div>
      </div>
      {/* Skills */}
      ...
      >
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <span
            ...
            style={{ background: "rgba(32,245,160,0.15)", color: "#4B5563" }}
          >
            LIVE DEMO
          </span>
        </div>
...
function MockScoutSearch() {
  return (
    ...
    >
      {/* Search bar */}
      <div
        className="flex items-center gap-2 rounded-md px-4 py-3 mb-4"
      ...
      {/* Results */}
      <div className="text-[11px] font-bold uppercase tracking-wider mb-3" style={{ color: "#9CA3AF" }}>
      ...
      {[
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[11px]" style={{ color: "#6B7280" }}>{r.skills}</div>
          </div>
          <div
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          ...
          <div className="text-[11px]" style={{ color: "#6B7280" }}>48 hours &middot; 124 participants</div>
        </div>
      </div>
      {/* Winners */}
      <div
      ...
      {[
        { rank: "1st", name: "Maya R.", project: "AgentFlow", color: "#20F5A0" },
        ...
        >
          ...
          <div className="flex-1">
            ...
            <span className="text-[12px] ml-2" style={{ color: "#6B7280" }}>{w.project}</span>
          </div>
        </div>
      ))}
      {/* Footer */}
      <div
        ...
        style={{ borderTop: "1px solid #F3F4F6", color: "#6B7280" }}
      >
        <CheckCircle2 className="w-3.5 h-3.5" style={{ color: "#20F5A0" }} />
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F7F8FA" }}>
      {/* ═══════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════ */}
      <section className="relative pt-28 pb-24 px-6 overflow-hidden" style={{ background: "#F7F8FA" }}>
        {/* Soft background orbs */}
        <div
          className="absolute top-[-120px] left-[-80px] w-[600px] h-[600px] rounded-full opacity-40 blur-[120px] pointer-events-none"
          style={{ background: "radial-gradient(circle, rgba(32,245,160,0.15) 0%, transparent 70%)" }}
        />
        <div
          className="absolute bottom-[-80px] right-[-60px] w-[500px] h-[500px] rounded-full opacity-30 blur-[100px] pointer-events-none"
          style={{ background: "radial-gradient(circle, rgba(32,245,160,0.08) 0%, transparent 70%)" }}
        />
        ...
        <div className="max-w-[980px] mx-auto text-center relative z-10">
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{ background: "rgba(32,245,160,0.45)" }}
                />
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
              <Link
                href="/builders"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-lg text-[15px] font-bold transition-all duration-200 hover:-translate-y-[1px]"
                style={{
                  background: "#20F5A0",
                  color: "#111111",
                  boxShadow: "0 0 20px rgba(32,245,160,0.25), 0 4px 12px rgba(0,0,0,0.05)",
                }}
              >
                Browse builders
              ...
              <Link
                href="/agent"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-lg text-[15px] font-semibold transition-all duration-200 hover:-translate-y-[1px]"
                style={{
                  background: "#FFFFFF",
                  color: "#111111",
            ...
            <p className="mt-5 text-[13px] font-medium" style={{ color: "#6B7280" }}>
              Hiring? Email{" "}
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div
                  className="w-12 h-12 rounded-lg mx-auto flex items-center justify-center mb-5"
                  style={{ background: "#FFFFFF", border: "1px solid #E5E7EB" }}
                >
                  <item.icon className="w-5 h-5" style={{ color: "#6B7280" }} />
                </div>
                <h3
      ...
      {/* ═══════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════ */}
      <section className="py-22 px-6" style={{ background: "#F7F8FA" }}>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
            ...
            >
              <div
                ...
                style={{ background: "rgba(32,245,160,0.12)", color: "#4B5563" }}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                className="group p-7 rounded-lg transition-all duration-300 hover:-translate-y-1"
                style={{
                  background: "#F7F8FA",
                  border: "1px solid #E5E7EB",
              ...
              >
                <div
                  className="w-11 h-11 rounded-md flex items-center justify-center mb-5 transition-transform duration-300 group-hover:scale-110"
                  style={{ background: "rgba(32,245,160,0.12)" }}
                >
      ...
      {/* ═══════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════ */}
      <section className="py-20 px-6" style={{ background: "#F3F4F6" }}>
        <div className="max-w-[900px] mx-auto">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            ...
            {[
              ...
              >
                ...
                <div
                  ...
                  style={{ color: "rgba(32,245,160,0.12)" }}
                >
                  {item.step}
                </div>
      ...
      {/* ═══════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════ */}
      <section id="join" className="py-24 px-6" style={{ background: "#F7F8FA" }}>
