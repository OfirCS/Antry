...
const techStack = [
  ...
  { name: "AI / LLM", icon: Brain, color: "#C6F135" },
    ...
    <div style={{ background: "#FAFAF7" }} className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 40% at 70% 20%, rgba(198,241,53,0.1) 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              <motion.div
                ...
                className="mb-6"
              >
                <span className="inline-flex items-center gap-2 rounded-full border border-[#EBEBEB] bg-white px-4 py-1.5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[12px]" style={{ color: "#737373" }}>Builder</p>
                </div>
              </motion.div>
              ...
              >
                {techStack.map((tech) => (
                  <span
                    key={tech.name}
                    className="inline-flex items-center gap-2 rounded-full border border-[#EBEBEB] bg-white px-4 py-2 text-[13px] font-medium"
                    style={{ color: "#525252" }}
                  >
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-[#D4D4D4] bg-white px-7 py-3.5 text-[14px] font-semibold transition-all duration-200 hover:bg-[#F5F5F5] hover:border-[#BEBEBE]"
                  style={{ color: "#111111" }}
                >
                  View Source
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className="h-8 w-8 rounded-xl flex items-center justify-center text-[12px] font-bold font-display"
                        style={{ background: "#C6F135", color: "#111111" }}
                      >
                        W
                      </div>
                  ...
                  >
                    ...
                    <p className="text-[32px] font-bold text-white font-display tracking-tight">
                      $124,847
                      <span className="ml-2 text-[14px] font-medium" style={{ color: "#C6F135" }}>
                        +12.4%
                      </span>
                    </p>
                  </div>
      ...
      <section className="mx-auto max-w-[1240px] px-6 sm:px-10 -mt-4 relative z-10 mb-20">
        ...
        >
          <div className="rounded-[24px] border border-[#EBEBEB] bg-white overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
            {/* Video embed */}
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-[#EBEBEB]">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-[13px] font-medium text-[#111111] hover:text-[#525252] transition-colors"
              >
                Open in Cap
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group rounded-[20px] border border-[#EBEBEB] bg-white p-7 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:border-[#C6F135]/30"
            >
              <div
                className="h-11 w-11 rounded-2xl flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110"
                style={{
      ...
      <section className="mx-auto max-w-[1240px] px-6 sm:px-10 mb-24">
        ...
        >
          ...
          <p className="text-[17px] leading-relaxed max-w-xl" style={{ color: "#525252" }}>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.5, ease }}
            className="rounded-[20px] overflow-hidden border border-[#EBEBEB]"
          >
            <div
            ...
            >
              <div className="text-center px-8">
                ...
                >
                  <LineChart size={16} style={{ color: "#C6F135" }} />
                  <span
            ...
            >
              <div className="text-center px-8">
                <div
                  ...
                  style={{ background: "rgba(198,241,53,0.15)" }}
                >
                  <Brain size={16} style={{ color: "#C6F135" }} />
                  <span
                    className="text-[13px] font-medium"
                    style={{ color: "#C6F135" }}
                  >
          ...
          <motion.div
            ...
            className="sm:col-span-2 rounded-[20px] overflow-hidden border border-[#EBEBEB]"
          >
            <div
            ...
            >
              <div className="text-center px-8">
                <div
                  ...
                  style={{ background: "rgba(198,241,53,0.15)" }}
                >
                  <Wallet size={16} style={{ color: "#C6F135" }} />
                  <span
                    className="text-[13px] font-medium"
                    style={{ color: "#C6F135" }}
                  >
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {techDeepDive.map((tech, index) => (
              <motion.div
                ...
                className="group rounded-[20px] border border-[#EBEBEB] bg-white p-8 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:border-[#C6F135]/30"
              >
                <div className="flex items-start gap-5">
                  ...
                  >
                    <tech.icon size={22} style={{ color: "#C6F135" }} />
                  </div>
                  <div>
      ...
      <section className="mx-auto max-w-[1240px] px-6 sm:px-10 mb-24">
        ...
        >
          ...
          <div className="rounded-[24px] border border-[#EBEBEB] bg-white p-8 sm:p-10 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            <div className="flex flex-col sm:flex-row items-start gap-6">
              {/* Avatar */}
              <div
                className="h-20 w-20 rounded-2xl flex items-center justify-center text-[24px] font-bold font-display shrink-0"
                style={{ background: "#C6F135", color: "#111111" }}
              >
                OS
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-[15px] text-[#525252] leading-relaxed mb-6 max-w-2xl">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Link
                    href="/showcase"
                    className="inline-flex items-center gap-2 rounded-full border border-[#EBEBEB] bg-white px-5 py-2.5 text-[13px] font-semibold text-[#111111] transition-all duration-200 hover:border-[#D4D4D4] hover:bg-[#F5F5F5]"
                  >
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 50% 60% at 50% 100%, rgba(198,241,53,0.1) 0%, transparent 70%)",
              }}
            />
            <div
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  <Sparkles size={14} style={{ color: "#C6F135" }} />
                  <span
                    className="text-[12px] font-semibold uppercase tracking-wider"
                    style={{ color: "#C6F135" }}
                  >
